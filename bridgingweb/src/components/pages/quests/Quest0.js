...
import imgbg from '../../../assets/Hunger Games/Quest0.jpg';
        ...
        <div className='text-brown relative'>
                            ...
                            >
                                ...
                                <ol className='list-decimal ml-4'>
                                    ...
                                    <li>
                                        ...
                                        <b>Tuesday, 13th September 2022, 23:59.</b>
                                    </li>
                                    <br />
                                    <li>
            ...
            <div className='flex flex-col mt-8 w-11/12 mx-auto gap-10'>
                <div className='bg-[#C18D56] w-full max-w-[1024px] mx-auto shadow-lg flex flex-col items-center px-8 pt-6 pb-10 gap-6 rounded mb-10'>
                            ...
                            >
                                <ol className='list-decimal ml-4'>
                                    <li>
                                        ...
                                        <ol className='list-[lower-roman] ml-5'>
                                            <li> Motivation to join GMUNC </li>
                                            <li> Expectations of what being in GMUNC would be like. </li>
                                            <li> What you can contribute to GMUNC.</li> 
                                            <li> Other subjects you think are necessary.</li>
                                    ...
                                    <li>
                                        The naming format will be {''}
                                        <b> Full Name_NIM_Motlet</b>, the file 
                                        should be submitted in pdf format.
                                    </li>
                                    <br />
                                    <li>
                                        The deadline for this task will be on {''}
                                        <b className="text-red"> Tuesday, 13 September 2022, 23:59.</b>
                                    </li>
                                    <br />
                                    <li>
                                        If there are any questions, ask them in
                    ...
                    <SubmitButton>
                        <a
                            href='https://forms.gle/zBddNvRLQ1ttpt4S6'
                            target='_blank'
                            rel='noreferrer'
                        >
                            Submit Assignment

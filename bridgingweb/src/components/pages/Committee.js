...
const Committee = () => {
    ...
    <div className ="background">
        <p className='flex justify-center text-4xl pt-20 font-bold'> OUR COMMITTEE </p>
        <div className='divisionbox'>
            < div className='divnamebox'>
                <p className='divname'> DIRECTOR </p>
            </div>
            < div className='rowcontainer'>
                <div className='committeebox'>
                    <img className="committeephoto" src={Dir_Asih}/>
                    <p className="biggerprofiletext"> Kinanti Wening Asih </p>
                    <p className= "smallerprofiletext"> Director </p>
                    <p className= "smallerprofiletext"> 18221044 </p>
                    <p> Information System and</p>
                    <p> Technology </p>
                </div>
                <div className='committeebox'>
                    <img className="committeephoto"  src={ViceDir_Gaizka}/>
                    <p className="biggerprofiletext"> Gaizka Adilla Zahraini </p>
                    <p className= "smallerprofiletext"> Vice Director </p>
                    <p className= "smallerprofiletext"> 10721099 </p>
        ...
        <div className='divisionbox'>
            < div className='divnamebox'>
                <p className='divname'> SECRETARIES-GENERAL </p>
            </div>
            < div className='rowcontainer'>
                <div className='committeebox'>
                    <img className="committeephoto" src={Sec_Cherrylia}/>
                    <p className="biggerprofiletext"> Cherrylia Shafaa Putri </p>
                    <p className= "smallerprofiletext">  Secretary </p>
                    <p className= "smallerprofiletext"> 10721078 </p>
                    <p> Pharmaceutical Science  </p>
                    <p> and Technology  </p>
                </div>
                <div className='committeebox'>
                    <img className="committeephoto"  src={Trs_Chlara}/>
                    <p className="biggerprofiletext"> Chlara Puspa Amalia </p>
                    <p className= "smallerprofiletext"> Treasurer </p>
                    <p className= "smallerprofiletext"> (NIM) </p>
                    <p> (Major) </p>
                </div>
            </div>
        </div>
        ...
        <div className='divisionbox'>
            ...
            < div className='rowcontainer'>
                <div className='committeebox'>
                    ...
                    <p className= "smallerprofiletext"> 13321072 </p>
            ...
            < div className='rowcontainer'>
                ...
                <div className='committeebox'>
                    ...
                    <p className= "smallerprofiletext"> 13021047 </p>
                    <p> Chemical Engineering </p>
                </div>
            </div>
            < div className='rowcontainer'>
                <div className='committeebox'>
                    ...
                    <p className= "smallerprofiletext"> 10121038 </p>
                    <p> Mathematics</p>
                </div>
                <div className='committeebox'>
                    <img className="committeephoto" src={Event_Marcia}/>
                    <p className="biggerprofiletext"> Marcia Alana Sjarief </p>
                    <p className= "smallerprofiletext"> 15321017 </p>
            ...
            < div className='rowcontainer'>
                <div className='committeebox'>
                    <img className="committeephoto" src={dummy}/>
                    <p className="biggerprofiletext"> Erriezzha Arriefqi </p>
                    <p className="biggerprofiletext"> Hidayat </p>
                    <p className= "smallerprofiletext">  12121060 </p>
                ...
                <div className='committeebox'>
                    ...
                    <p className= "smallerprofiletext"> 19021035 </p>
                    <p> International Business </p>
                </div>
            </div>
        </div>
        ...
        <div className='divisionbox'>
            < div className='divnamebox'>
                <p className='divname'> ACADEMICS </p>
            </div>
            < div className='rowcontainer'>
                <div className='committeebox'>
                    ...
                    <p className= "smallerprofiletext"> Head of Academics </p>
                    <p className= "smallerprofiletext"> 13621005 </p>
            ...
            < div className='rowcontainer'>
                <div className='committeebox'>
                    ...
                    <p className= "smallerprofiletext"> 13621022 </p>
                    <p> Aerospace Engineering </p>
                </div>
                <div className='committeebox'>
                    <img className="committeephoto" src={dummy}/>
                    <p className="biggerprofiletext"> Aurelia Zadira </p>
                    <p className= "smallerprofiletext"> 13121034 </p>
            ...
            < div className='rowcontainer'>
                <div className='committeebox'>
                    ...
                    <p className="biggerprofiletext"> Annisa Edi Setiyani</p>
                    <p className= "smallerprofiletext"> 15421121 </p>
        ...
        <div className='divisionbox'>
            < div className='divnamebox'>
                <p className='divname'> HUMAN RESOURCES </p>
            </div>
            < div className='rowcontainer'>
                <div className='committeebox'>
                    <img className="committeephoto" src={HR_Fathiya}/>
                    <p className="biggerprofiletext"> Fathiya Amani Shabira </p>
                    <p className= "smallerprofiletext"> Head of Human Resources </p>
                    <p className= "smallerprofiletext"> 13221032 </p>
            ...
            < div className='rowcontainer'>
                ...
                <div className='committeebox'>
                    ...
                    <p className= "smallerprofiletext"> 15321006 </p>
            ...
            < div className='rowcontainer'>
                <div className='committeebox'>
                    ...
                    <p className="biggerprofiletext"> Aniqa Fayyaza Akbar </p>
                    <p className= "smallerprofiletext"> 18221020 </p>
                    <p> Information System and Technology </p>
                </div>
                <div className='committeebox'>
                    ...
                    <p className= "smallerprofiletext"> 12521038 </p>
        ...
        <div className='divisionbox'>
            < div className='divnamebox'>
                <p className='divname'> OPS-IT AND DOCUMENTATION </p>
            </div>
            < div className='rowcontainer'>
                <div className='committeebox'>
                    ...
                    <p className= "smallerprofiletext"> and Documentation </p>
                    <p className= "smallerprofiletext"> (NIM) </p>
                    <p> (Major) </p>
                </div>
            </div>
            < div className='rowcontainer'>
                <div className='committeebox'>
                    ...
                    <p className= "smallerprofiletext"> 13521116 </p>
            ...
            < div className='rowcontainer'>
                <div className='committeebox'>
                    ...
                    <p className="biggerprofiletext"> Nadhira Ismi Rasulla </p>
                    <p className= "smallerprofiletext"> (NIM) </p>
                    <p> (Major) </p>
                </div>
                <div className='committeebox'>
        ...
        <div className='divisionbox'>
            < div className='divnamebox'>
                <p className='divname'> CREATIVE AND PUBLICATION </p>
            </div>
            < div className='rowcontainer'>
                <div className='committeebox'>
            ...
            < div className='rowcontainer'>
                <div className='committeebox'>
                    ...
                    <p className= "smallerprofiletext"> 15421130 </p>
                    <p> Urban and Regional Planning  </p>
                </div>
                <div className='committeebox'>
                    ...
                    <p className= "smallerprofiletext"> 10721089 </p>
                    <p> Pharmaceutical Science </p>
                    <p> and Technology </p>
                </div>
            </div>
            < div className='rowcontainer'>
                <div className='committeebox'>
                    <img className="committeephoto" src={dummy}/>
                    <p className="biggerprofiletext"> Fayola Tabina Arby </p>
                    <p className= "smallerprofiletext"> (NIM) </p>
                    <p> (Major) </p>
                </div>
                <div className='committeebox'>
                    <img className="committeephoto" src={CretPub_Haifa}/>
                    <p className="biggerprofiletext"> Haifa Nurul Karimah</p>
                    <p className= "smallerprofiletext"> 10721008 </p>
                    <p> Pharmaceutical Science </p>
                    <p> and Technology </p>
                </div>
            </div>
